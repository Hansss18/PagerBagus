 ...
 <div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a href="#addproduct" data-toggle="modal" class="pull-right btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Produk</a>
		</div>
	</div>
		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				<?php
					...
					{
						$catid=$_GET['category'];
                                                $condition = $_SESSION['res_username'];
						$where = " WHERE product.categoryid = $catid and  product.company = '$condition'";
                                        }else{
                                                $condition = $_SESSION['res_username'];
						$where = " WHERE product.company = '$condition'";
                                        }
