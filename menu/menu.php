...
<div class="container">
	<h1 class="page-header text-center">MENU PAGER BAGUS</h1>
								...
								<div class="col-md-3">
									<div class="panel panel-default">
										...
										<div class="panel-footer text-center">
											Rp. <?php echo number_format($pfrow['price'], 3); ?>
										</div>
									</div>
								</div>
							<?php
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<img src="<?php if($prow['photo']==''){echo "../upload/noimage.jpg";} else{echo $prow['photo'];} ?>" height="225px;" width="100%">
                                                                                ...
                                                                                <div class="panel-footer text-center">
											Rp. <?php echo number_format($prow['price'], 3); ?>
										</div>
									</div>
								</div>
							<?php
...
<footer><center>© Copyright KKN Tematik Politeknik LP3I Bandung Kelompok 6 KBB 2 FANTASIX</center></footer>
</html>
